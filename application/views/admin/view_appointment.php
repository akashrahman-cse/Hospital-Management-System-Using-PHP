						...
						foreach ($appointments as $row) : ?>
							...
							<tr>
								...
								<td align="center">
									...
									<a href="<?php echo base_url(); ?>index.php?admin/manage_appointment/delete/<?php echo $row['appointment_id']; ?>" onclick="return confirm('delete?')" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Delete'); ?>" class="btn btn-danger">
